...
-spec pad_list(list(gleam@option:option(FKB)), integer()) -> list(gleam@option:option(FKB)).
pad_list(List, Size) ->
    _pipe = List,
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/uri.gleam", 238).
...
query_to_string(Query) ->
    ...
    _pipe@2 = gleam@list:intersperse(
        _pipe@1,
        gleam@string_tree:from_string(<<"&"/utf8>>)
    ),
    _pipe@3 = gleam@string_tree:concat(_pipe@2),
    gleam@string_tree:to_string(_pipe@3).

-file("/Users/louis/src/gleam/stdlib/src/gleam/uri.gleam", 255).
-spec percent_decode(binary()) -> {ok, binary()} | {error, nil}.
percent_decode(Value) ->
    gleam_stdlib:percent_decode(Value).

-file("/Users/louis/src/gleam/stdlib/src/gleam/uri.gleam", 283).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/uri.gleam", 358).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/uri.gleam", 437).
-spec drop_last(list(FLD)) -> list(FLD).
drop_last(Elements) ->
    gleam@list:take(Elements, erlang:length(Elements) - 1).

-file("/Users/louis/src/gleam/stdlib/src/gleam/uri.gleam", 441).
-spec join_segments(list(binary())) -> binary().
join_segments(Segments) ->
    gleam@string:join([<<""/utf8>> | Segments], <<"/"/utf8>>).

-file("/Users/louis/src/gleam/stdlib/src/gleam/uri.gleam", 381).
