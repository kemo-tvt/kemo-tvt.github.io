...
-export([from_string/1, byte_size/1, bit_size/1, slice/3, is_utf8/1, to_string/1, concat/1, append/2, base64_encode/2, base64_decode/1, base64_url_encode/2, base64_url_decode/1, base16_encode/1, base16_decode/1, inspect/1, compare/2, starts_with/2]).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 24).
-spec byte_size(bitstring()) -> integer().
byte_size(X) ->
    erlang:byte_size(X).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 16).
-spec bit_size(bitstring()) -> integer().
bit_size(X) ->
    erlang:bit_size(X).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 49).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 62).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 57).
-spec is_utf8(bitstring()) -> boolean().
is_utf8(Bits) ->
    is_utf8_loop(Bits).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 90).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 132).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 140).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 149).
-spec base16_encode(bitstring()) -> binary().
base16_encode(Input) ->
    binary:encode_hex(Input).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 153).
-spec base16_decode(binary()) -> {ok, bitstring()} | {error, nil}.
base16_decode(Input) ->
    gleam_stdlib:base16_decode(Input).

-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 172).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 167).
-spec inspect(bitstring()) -> binary().
inspect(Input) ->
    <<(inspect_loop(Input, <<"<<"/utf8>>))/binary, ">>"/utf8>>.

-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 214).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/bit_array.gleam", 254).
