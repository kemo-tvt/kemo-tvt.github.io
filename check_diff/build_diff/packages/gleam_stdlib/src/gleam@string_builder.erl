...
prepend(Builder, Prefix) ->
    gleam@string_tree:append_tree(
        gleam@string_tree:from_string(Prefix),
        Builder
    ).
...
append(Builder, Second) ->
    gleam@string_tree:append_tree(
        Builder,
        gleam@string_tree:from_string(Second)
    ).
...
append_builder(Builder, Suffix) ->
    gleam@string_tree:append_tree(Builder, Suffix).
...
from_strings(Strings) ->
    gleam@string_tree:from_strings(Strings).
...
lowercase(Builder) ->
    gleam@string_tree:lowercase(Builder).
...
uppercase(Builder) ->
    gleam@string_tree:uppercase(Builder).
...
reverse(Builder) ->
    gleam@string_tree:reverse(Builder).
