...
-spec optional(fun((dynamic_()) -> {ok, CJD} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(CJD)} |
    {error, list(decode_error())}).
optional(Decode) ->
...
-spec any(list(fun((dynamic_()) -> {ok, CND} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        CND} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-spec result(
    fun((dynamic_()) -> {ok, CIL} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CIN} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, CIL} | {error, CIN}} |
    {error, list(decode_error())}).
...
-spec list(fun((dynamic_()) -> {ok, CIY} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(CIY)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-spec map_errors(
    {ok, CHM} | {error, list(decode_error())},
...
) -> fun((dynamic_()) -> {ok, gleam@option:option(CJR)} |
    {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, {CKZ, CLB}} | {error, list(decode_error())}).
...
-spec tuple3(
    fun((dynamic_()) -> {ok, CLE} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLG} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLI} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {CLE, CLG, CLI}} | {error, list(decode_error())}).
...
-spec tuple4(
    fun((dynamic_()) -> {ok, CLL} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLN} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLP} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLR} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {CLL, CLN, CLP, CLR}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, {CLU, CLW, CLY, CMA, CMC}} |
    {error, list(decode_error())}).
...
-spec tuple6(
    ...
    fun((dynamic_()) -> {ok, CMH} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CMJ} | {error, list(decode_error())}),
...
) -> fun((dynamic_()) -> {ok, {CMF, CMH, CMJ, CML, CMN, CMP}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(CMS, CMU)} |
    {error, list(decode_error())}).
...
-spec decode6(
    fun((COV, COW, COX, COY, COZ, CPA) -> CPB),
...
-spec decode7(
    fun((CPJ, CPK, CPL, CPM, CPN, CPO, CPP) -> CPQ),
...
-spec decode8(
    fun((CPZ, CQA, CQB, CQC, CQD, CQE, CQF, CQG) -> CQH),
...
-spec decode9(
    fun((CQR, CQS, CQT, CQU, CQV, CQW, CQX, CQY, CQZ) -> CRA),
